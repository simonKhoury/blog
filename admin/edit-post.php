...
<div id="wrapper">
	...
	if(isset($error)){
		...
		try {
			...
			$stmt = $db->prepare('SELECT postID, postTitle, postDesc, postCont, post_audio_url FROM blog_posts WHERE postID = :postID') ;
...
-->
		...
		<div class="row">
			<div class="cold-md-8">
				...
				<input type='text' name='audio' value='<?php echo $row['post_audio_url'];?>'></p>
			</div>
		</div>			
